...
//GÖRÜŞ/ÖNERİ/ŞİKAYET SİLMEK

if(isset($_SESSION['key'])){
if(@$_GET['fdid'] && $_SESSION['key']=='199835') {
$id=@$_GET['fdid'];
...
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='199835') {
$demail=@$_GET['demail'];
...
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='199835') {
$eid=@$_GET['eid'];
...
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='199835') {
$name = $_POST['name'];
$uppercase_input = mb_strtoupper($name, 'utf-8');
...
$desc = $_POST['desc'];
$id=uniqid();
$q3=mysqli_query($con,"INSERT INTO quiz VALUES  ('$id','$uppercase_input' , '$sahi' , '$wrong','$total','$time' ,'$desc','$tag', NOW())");
...
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='199835') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
